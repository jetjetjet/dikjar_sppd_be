...
use App\Http\Controllers\Api\V1\BidangController;
use App\Http\Controllers\Api\V1\BiayaController;
use App\Http\Controllers\Api\V1\CekSPTController;
use App\Http\Controllers\Api\V1\DashboardController;
use App\Http\Controllers\Api\V1\InapController;
use App\Http\Controllers\Api\V1\JabatanController;
use App\Http\Controllers\Api\V1\JenisTransportController;
use App\Http\Controllers\Api\V1\KategoriPengeluaranController;
use App\Http\Controllers\Api\V1\NotifController;
use App\Http\Controllers\Api\V1\PegawaiController;
use App\Http\Controllers\Api\V1\PejabatTtdController;
...
use App\Http\Controllers\Api\V1\SPTLogController;
use App\Http\Controllers\Api\V1\TransportController;
use App\Http\Controllers\Api\V1\TujuanDalamController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // Biaya
        Route::get('/biaya/grid/{biayaId}/{pegawaiId}', [BiayaController::class, 'grid']);
